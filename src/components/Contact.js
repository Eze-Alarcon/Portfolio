...
const Contact = () => {
    ...
    <main>
		...
		<section class="C-description">
			...
			<p class="text">
				I&#39d love to hear about what you&#39re working on and how I could help. I&#39m currently 
				looking for a new role and am open to a wide range of opportunities. My preference 
				would be to find a position in a company in London. But I&#39m also happy to hear about 
				opportunites that don&#39t fit that description. I&#39m a hard-working and positive person 
			...
			<div class="icons">
				...
				<a href=".#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path fill="#33323D" d="M21.6 0H2.4C1.08 0 0 1.08 0 2.4v19.2C0 22.92 1.08 24 2.4 24h19.2c1.32 0 2.4-1.08 2.4-2.4V2.4C24 1.08 22.92 0 21.6 0zM7.2 20.4H3.6V9.6h3.6v10.8zM5.4 7.56c-1.2 0-2.16-.96-2.16-2.16 0-1.2.96-2.16 2.16-2.16 1.2 0 2.16.96 2.16 2.16 0 1.2-.96 2.16-2.16 2.16zm15 12.84h-3.6v-6.36c0-.96-.84-1.8-1.8-1.8-.96 0-1.8.84-1.8 1.8v6.36H9.6V9.6h3.6v1.44c.6-.96 1.92-1.68 3-1.68 2.28 0 4.2 1.92 4.2 4.2v6.84z"/></svg></a>
			</div>
		...
		<section class="C-form">
			...
			<form action="#" class="contact-form">
				...
				<label class="formLabel" for="fullName">Name</label>
				<input class="textField" id="fullName" type="text" placeholder="Jane Appleseed"/>

				<label class="formLabel" for="email">Email Address</label>
				<input class="textField" id="email" type="email" placeholder="email@example.com"/>

				<label class="formLabel" for="message">Message</label>
				<textarea class="textArea" name="message" id="message" placeholder="How can I help?" cols="30" rows="10"></textarea>
