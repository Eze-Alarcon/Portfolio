...
const { data } = useContext(LangContext)
    ...
    const projectImages = data.projects.details.manage.images 
    const projectIntro = data.projects.details.manage.intro
    const projectData = data.projects.details.manage.projectDescription
